...
List<Product> listWine = productService.getProductByCatetory(1);
%>
<!--Author: W3layouts
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="wines.jsp">Wines</a></li>
			...
			<script type="text/javascript">
			 ...
			 %>
			 	<div class="view view-seventh">
                    <a href="<%=listWine.get(i).getProductImage() %>" class="b-link-stripe b-animate-go  swipebox"  title="<%=listWine.get(i).getProductName() %>"><img src="<%=listWine.get(i).getProductImage() %>" alt="" class="img-responsive">
                    <div class="mask">
                       <h4>WINE</h4>
                    </div></a>
                </div>		 
